            ...
            <?php if(!isset($_SESSION["username"])){ ?>
                <form action="<?php echo base_url('Login') ?>" method="post">
                    <div class="input-box">
                        ...
                        <small id="helpid" class="form-text text-muted"><?php echo form_error('username') ?></small>
                    </div>
                    ...
                    <div class="login-register">
                        <p><a href="<?php echo base_url('register') ?>" class="register-link">Create Account</a></p>
                    </div>
                </form>
            <?php } else { ?>
