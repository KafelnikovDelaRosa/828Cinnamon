...
<head>
    ...
    <title>828 Admin - Production Schedule </title>
...
<body>
    <main>
        ...
        <section>
            <p class="tagline">Production Schedules</p>
        </section>
    </main>
    <script>
        var donutOptions = {
        chart: {
            ...
            series: [1,2,3],
            labels: ['In Progress','Cancelled','Completed'],
        }
        var donutChart = new ApexCharts(document.querySelector("#orders"), donutOptions);
        donutChart.render();
        var favoredOptions = {
        chart: {
            height: 500,
            ...
            series: [1,1,1],
            labels: ['Classic Cinnaroll','Plain Cinnaroll','Premium Cinnaroll'],
        }
        var favorChart = new ApexCharts(document.querySelector("#favorite"), favoredOptions);
        favorChart.render();
    </script>
</body>
</html>