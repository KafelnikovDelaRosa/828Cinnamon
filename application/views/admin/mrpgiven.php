...
<body>
    ...
    <main>
        <section>
            <h2><a href="<?php echo base_url('mrp') ?>" class='header-link-group'>MRP</a>>Given</h2>
                ...
                <form action="<?php echo base_url('mrp/given') ?>" method="POST">
                    <div class="field-groups">
                        <div class="input-group">
                            ...
                            <input type="number" onchange="handleNums('.num1')" name="no_rolls" value="<?php echo $total?>" class="input-form-group num1" readonly>
