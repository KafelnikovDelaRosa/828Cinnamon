    ...
    <main>
        <?php
            $config=array(
                ...
                'table_headers'=>array('Id','Email','Phone','Address','Order Created','Order Completed','Order Cancelled','Order Due','Payment Method','Status','Action'),
                'root_url'=>'order',
                'entry_keys'=>array('orderid','email','phone','address','ordercreated','ordercompleted','ordercancelled','orderdue','paymentmode','orderstatus'),
                'entries' =>$entries
            );
            crud($config);
        ?>
